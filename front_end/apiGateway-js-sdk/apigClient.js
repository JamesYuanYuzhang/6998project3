...
apigClientFactory.newClient = function (config) {
    ...
    var invokeUrl = 'https://u4lmwfzkv1.execute-api.us-east-2.amazonaws.com/v1';
    ...
    apigClient.searchgetGet = function (params, body, additionalParams) {
        if(additionalParams === undefined) { additionalParams = {}; }
        
        apiGateway.core.utils.assertParametersDefined(params, ['q'], ['body']);
        
        var searchgetGetRequest = {
            verb: 'get'.toUpperCase(),
            path: pathComponent + uritemplate('/searchget').expand(apiGateway.core.utils.parseParametersToObject(params, [])),
        ...
        return apiGatewayClient.makeRequest(searchgetGetRequest, authType, additionalParams, config.apiKey);
    };
    
    
    apigClient.searchgetOptions = function (params, body, additionalParams) {
        if(additionalParams === undefined) { additionalParams = {}; }
        
        apiGateway.core.utils.assertParametersDefined(params, [], ['body']);
        
        var searchgetOptionsRequest = {
        ...
        return apiGatewayClient.makeRequest(searchgetOptionsRequest, authType, additionalParams, config.apiKey);
    };
